...
const archiveMessages = {
  ko: {
    ...
    presenterFilterLabel: "발표자 필터",
    allPresenters: "전체 발표자",
    all: "전체",
    noMatchesTitle: "조건에 맞는 논문이 없습니다.",
    noMatchesDescription: "검색어, 발표 상태 또는 발표자를 바꿔보세요.",
  ...
  en: {
    ...
    presenterFilterLabel: "Presenter filter",
    allPresenters: "All presenters",
    all: "All",
    noMatchesTitle: "No papers match your search.",
    noMatchesDescription: "Try a different search, presentation status, or presenter.",
